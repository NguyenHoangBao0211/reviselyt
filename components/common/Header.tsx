      ...
      <div className="mx-auto max-w-6xl flex justify-between items-center px-6 py-4">
        ...
        <Link href={variant === "dashboard" ? "/dashboard" : "/"}>
          <div className="flex items-center gap-2">
            <span className="text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500 hover:opacity-90 transition">
              Reviselyt
            </span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {variant === "dashboard" && user && (
            <>
              ...
              <button
                onClick={onLogout}
                className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-4 py-2 rounded-lg font-medium hover:opacity-90 transition shadow-lg"
              >
                Logout
              </button>
            </>
          ...
          <div className="flex flex-col px-6 py-4 gap-4">
            {variant === "landing" && (
              <>
                ...
                <Link
                  href="/auth/login"
                  className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-4 py-2 rounded-lg font-medium text-center"
                  onClick={() => setMenuOpen(false)}
                >
                  Get Started
                </Link>
